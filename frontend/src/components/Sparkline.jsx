...
export function Sparkline({ series, valueKey, color, fill, decimals, unit = '', selectedIndex, height = 78 }) {
  ...
  return (
    <svg viewBox="0 0 320 78" preserveAspectRatio="none" style={{ width: '100%', height, display: 'block' }}>
      <line x1="0" y1="70" x2="320" y2="70" stroke="rgba(255,255,255,0.12)" strokeWidth="1" />
      <line x1="0" y1="8" x2="320" y2="8" stroke="rgba(255,255,255,0.09)" strokeWidth="1" strokeDasharray="2 4" />
      ...
      <line x1={mx} y1="0" x2={mx} y2="72" stroke="rgba(255,255,255,0.32)" strokeWidth="1" strokeDasharray="2 3" />
      <circle cx={mx} cy={my} r="3.4" fill={color} stroke="rgba(0,0,0,0.85)" strokeWidth="1.4" />
    </svg>
  );
}
